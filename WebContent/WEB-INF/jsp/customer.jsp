...
<%@ taglib prefix="itheima" uri="http://com/common/"%><!-- 这里使用自定义的标签库，地址在tld中 -->
<%
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu dropdown-user">
				...
				<li class="divider"></li>
				<li>
					<a href="${pageContext.request.contextPath }/logout.action"><!-- 这里可以使用ctrl+F进行快捷查找 -->
	...
	<div id="page-wrapper">
		...
		<a href="#" class="btn btn-primary" data-toggle="modal" 
		           data-target="#newCustomerDialog" onclick="clearCustomer()">新建</a><!-- 这个按钮弹出一个静态框data-target -->
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td>
									   <!-- data-toggle找到一个模态框，data-targe模态框的地址 -->
...
//清空新建客户窗口中的数据
	...
	$("#new_customer_form").serialize(),function(data){//通过conrtoller返回一个字符串
	        if(data =="OK"){
	            alert("客户创建成功！");
	...
	// 通过id获取修改的客户信息
	function editCustomer(id) {//传入一个id,得到返回的一个customer对象,然后将值显示在模态框中
	    $.ajax({
	        type:"get",
